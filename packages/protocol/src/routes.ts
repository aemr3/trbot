...
export const ROUTES = {
  ...
  chatPromptHistory: (id: string) => `${API_PREFIX}/ai/chat/sessions/${encodeURIComponent(id)}/prompts`,
  ...
  chatMobile: (id: string) => `${API_PREFIX}/ai/chat/sessions/${encodeURIComponent(id)}/mobile`,
